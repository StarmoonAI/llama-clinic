...
const Steps: React.FC<{
    ...
    let heading = "Let's get your Llama Clinic device & account set up";
    let subHeading =
        "We want to make sure that your Llama Clinic is set up to provide you the best experience possible.";

    if (step === 1) {
        if (selectedType === "doctor") {
            heading = "Hello Doctor!";
            subHeading =
                "With the following details we will be able to personalize your and your patients' Llama Clinic experience.";
        } else {
            heading = "Hello there!";
            subHeading =
                "With the following details we will be able to personalize your Llama Clinic experience.";
        }
    }
